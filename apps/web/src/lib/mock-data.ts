...
export const MOCK_SWIPE_PROFESSIONALS: any[] = [
  ...
  { profileId: 'pro-lucas', firstName: 'Lucas', lastName: 'Martin', avatarUrl: AVATARS.lucas, bio: 'Mathematics teacher with a passion for making complex concepts simple.', age: 28, hourlyRate: 45, distance: 0.8, averageRating: 4.9, reviewCount: 2, category: 'TUTORING', services: ['Math Tutoring', 'Science Tutoring'], verified: true, availability: [{ day: 1, start: '10:00', end: '20:00' }, { day: 2, start: '10:00', end: '20:00' }, { day: 3, start: '10:00', end: '20:00' }, { day: 4, start: '10:00', end: '20:00' }, { day: 5, start: '10:00', end: '20:00' }, { day: 6, start: '10:00', end: '16:00' }] },
  ...
  { profileId: 'pro-chiara', firstName: 'Chiara', lastName: 'Ferrari', avatarUrl: AVATARS.chiara, bio: 'Babysitter con esperienza pluriennale, parlo inglese e francese. Amo giocare e insegnare.', age: 26, hourlyRate: 18, distance: 1.6, averageRating: 4.8, reviewCount: 5, category: 'BABYSITTING', services: ['Babysitting', 'After-School Care'], verified: true, availability: [{ day: 1, start: '14:00', end: '22:00' }, { day: 2, start: '14:00', end: '22:00' }, { day: 3, start: '14:00', end: '22:00' }, { day: 4, start: '14:00', end: '22:00' }, { day: 5, start: '14:00', end: '23:00' }, { day: 6, start: '14:00', end: '23:00' }] },
  ...
  { profileId: 'pro-luca', firstName: 'Luca', lastName: 'Mancini', avatarUrl: AVATARS.luca, bio: 'Dog walker appassionato. Percorsi personalizzati per cani di tutte le taglie.', age: 24, hourlyRate: 12, distance: 0.9, averageRating: 4.8, reviewCount: 4, category: 'PET_SITTING', services: ['Dog Walking'], verified: false, availability: [{ day: 0, start: '06:00', end: '12:00' }, { day: 1, start: '06:00', end: '10:00' }, { day: 1, start: '17:00', end: '20:00' }, { day: 2, start: '06:00', end: '10:00' }, { day: 2, start: '17:00', end: '20:00' }, { day: 3, start: '06:00', end: '10:00' }, { day: 3, start: '17:00', end: '20:00' }, { day: 4, start: '06:00', end: '10:00' }, { day: 4, start: '17:00', end: '20:00' }, { day: 5, start: '06:00', end: '10:00' }, { day: 5, start: '17:00', end: '20:00' }, { day: 6, start: '06:00', end: '12:00' }] },
